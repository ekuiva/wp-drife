...
<?php get_header(); ?>
    ...
    <section class="bg-home1">
        ...
        while ($menu->have_posts()) {
            ...
            ?>
            <div class="prlx-1 pc_dis"
                 style="background: url('<?php echo $url; ?>') no-repeat center 100% fixed;-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;height:1000px"></div>
            ...
            <div class="col-md-6">
                ...
                <div class="btn-empower-me-align">
                    <a href="#services-section-id" id="services-section">
                        <button class="btn-empower-me"
                                onmouseout="document.getElementById('btnred').className='back-button-empower-me-show';"
                                onmouseover="document.getElementById('btnred').className='back-button-empower-me-hidden';">
                            EMPOWER ME!
                        </button>
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                ...
                                while ($menu->have_posts()) {
                                    ...
                                    if (count($alt)) ;
                                    ?>
                                    <div class="swiper-slide"><img src="<?php echo $url_img; ?>"
        ...
        <div class="col-md-12 bg-home2">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="title-we-do space-title">WE HELP BRANDS GROW THEIR DIGITAL ASSETS TO THEIR FULLEST
                        EXTENT
                    </div>
                    <!-- ancor scroll tujuan -->
                    <a id="services-section-id" name="services-section-name"></a>
                    <div class="description-we-do">Establishing sustainable digital assets are not easy. But hardship
                        and preserverance are things that help us grow.
                    </div>
                            ...
                            $menu->the_post();
                            {
                                ...
                                <div class="col-md-3 col-sm-5 item-wedo-space">
                                    <a href="<?php the_permalink(); ?>"
                                       title="Know more about <?php the_title(); ?>...">
                                        ...
                                        <div class="button-wedo">
                                            <a href="<?php the_permalink(); ?>">
                                                ...
                                                ?>
                                                <img class="img-button-right"
                                                     src="<?php bloginfo('template_directory'); ?>/library/images/right.png">
                                            </a>
                                        </div>
                                    </a>
                                </div>
    ...
    <div class="row">
        <div class="col-md-12 newsletters">
            <div class="row">
                <div class="col-md-2"></div>
                <div class="col-md-10">
                    <form onsubmit="submit_formwishlist();return false;" name="subscribeform" method="post"
                          id="formnewsletters" class="class-formnewsletters">
                        <div class="row space-maring-newsletters">
                            ...
                            <div class="col-md-3 col-sm-5">
                                ...
                                <div class="form-input-newsletters-div">
                                    <input type="text" name="attribute1"
                                           class="form-input-newsletters attributeinput name-newsletters">
                            ...
                            <div class="col-md-3 col-sm-2">
                                <div class="form-input-names">
                                    <input type="SUBMIT" name="input-name" class="form-button-newsletters"
                                           value="SUBMIT">
            ...
            <div class="row space-portfolio">
                ...
                <?php if ($fn >= 6) { ?>
                    <div class="col-md-12 more-news" align="center">
                        <div class="load_more load_portfolio_in_home" data-idpage="<?php echo $post->ID; ?>"
                             title="View More">
                            <a>
